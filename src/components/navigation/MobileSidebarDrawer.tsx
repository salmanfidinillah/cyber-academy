...
export const MobileSidebarDrawer: React.FC<MobileSidebarDrawerProps> = ({ isOpen, onClose, ...sidebarProps }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 md:hidden">
      ...
      >
        ...
        <AppSidebar {...sidebarProps} onNavigate={handleNavigate} collapsed={false} onToggle={onClose} isMobile={true} />
      </div>
    </div>
  );
};
